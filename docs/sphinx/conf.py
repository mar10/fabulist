...
latex_documents = [
  (master_doc, 'fabulist.tex', u'fabulist Documentation',
...
man_pages = [
    (master_doc, 'fabulist', u'fabulist Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'fabulist', u'fabulist Documentation',
   author, 'fabulist', 'One line description of project.',
   'Miscellaneous'),
]
